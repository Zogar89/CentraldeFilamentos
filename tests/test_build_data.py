...
def test_build_filamentos3d_enrichments_matches_3n3_tpu_flex_to_provider_tpu_metadata():
    enrichments = build_filamentos3d_enrichments(
        [
            raw(
                "filamentos3d",
                "Filamentos3D",
                "Zona Sur",
                "3N3 TPU Flex Negro 500g 1.75mm",
                4,
                brand_hint="3N3",
            )
        ],
        metadata={
            "tpu-negro-175-500-3n3": {
                "image_url": "assets/filamentos3d/3n3-tpu-negro.jpg",
                "sku": "TPU-NEGRO",
            }
        },
    )

    assert enrichments["tpu-flex-negro-175-500-3n3"]["image_url"] == "assets/filamentos3d/3n3-tpu-negro.jpg"
    assert enrichments["tpu-flex-negro-175-500-3n3"]["sku"] == "TPU-NEGRO"


def test_build_filamentos3d_enrichments_matches_3n3_tpu_flex_without_diameter_to_provider_tpu_metadata():
    enrichments = build_filamentos3d_enrichments(
        [
            raw(
                "filamentos3d",
    ...
    assert enrichments["tpu-flex-negro-unknown-500-3n3"]["image_url"] == "assets/filamentos3d/3n3-tpu-negro.jpg"
...
def test_build_grilon3_enrichments_uses_suffixed_standard_metadata_before_large_roll(monkeypatch):
    monkeypatch.setattr(
        "centraldefilamentos.build_data.load_grilon3_metadata",
        lambda: {
            "petg-blanco-unknown-1000-grilon3": {
                "manufacturer_product_url": "https://grilon3.com.ar/producto/maxicarrete-petg-blanco/",
                "image_url": "assets/grilon3/petg-maxicarrete-blanco.jpg",
                "sku": "SKU-LARGE",
            },
            "petg-blanco-unknown-1000-grilon3-filamento-3d-petg-blanco": {
                "manufacturer_product_url": "https://grilon3.com.ar/producto/filamento-3d-petg-blanco/",
                "image_url": "assets/grilon3/petg-blanco.jpg",
                "sku": "SKU-STANDARD",
            },
        },
    )
    ...
    enrichments = build_grilon3_enrichments(
        [
            raw(
                ...
                "Filamentos3D",
                "Zona Sur",
                "GRILON3 PETG Blanco 1kg 1.75mm",
                4,
                brand_hint="Grilon3",
            )
        ],
    ...
    enrichment = next(iter(enrichments.values()))
    assert enrichment["manufacturer_product_url"] == "https://grilon3.com.ar/producto/filamento-3d-petg-blanco/"
    assert enrichment["image_url"] == "assets/grilon3/petg-blanco.jpg"
    assert enrichment["sku"] == "SKU-STANDARD"


def test_build_grilon3_enrichments_keeps_direct_metadata_when_suffixed_duplicate_exists(monkeypatch):
    monkeypatch.setattr(
        "centraldefilamentos.build_data.load_grilon3_metadata",
        lambda: {
            "pla-bordo-unknown-1000-grilon3": {
                "manufacturer_product_url": "https://grilon3.com.ar/producto/filamento-3d-pla-bordo/",
                "image_url": "assets/grilon3/pla-bordo.jpg",
            },
            "pla-bordo-unknown-1000-grilon3-filamento-3d-pla-bordo-2": {
                "manufacturer_product_url": "https://grilon3.com.ar/producto/filamento-3d-pla-bordo-2/",
                "image_url": "assets/grilon3/pla-850-bordo.jpg",
            },
        },
    )
    ...
    enrichment = next(iter(enrichments.values()))
    assert enrichment["manufacturer_product_url"] == "https://grilon3.com.ar/producto/filamento-3d-pla-bordo/"
    assert enrichment["image_url"] == "assets/grilon3/pla-bordo.jpg"


def test_build_grilon3_enrichments_uses_family_metadata_when_weight_is_missing(monkeypatch):
    monkeypatch.setattr(
        "centraldefilamentos.build_data.load_grilon3_metadata",
        lambda: {
            "petg-chocolate-unknown-1000-grilon3": {
                "manufacturer_product_url": "https://grilon3.com.ar/producto/filamento-3d-petg-chocolate/",
                "image_url": "assets/grilon3/petg-chocolate.jpg",
            },
        },
    )
    ...
    enrichment = next(iter(enrichments.values()))
    assert enrichment["manufacturer_product_url"] == "https://grilon3.com.ar/producto/filamento-3d-petg-chocolate/"
    assert enrichment["image_url"] == "assets/grilon3/petg-chocolate.jpg"


def test_build_grilon3_enrichments_uses_petg_clear_family_metadata_for_legacy_provider_names(monkeypatch):
    monkeypatch.setattr(
        "centraldefilamentos.build_data.load_grilon3_metadata",
        lambda: {
            "petg-petg-clear-clear-verde-unknown-1000-grilon3": {
                "manufacturer_product_url": "https://grilon3.com.ar/producto/filamento-3d-petg-clear-verde/",
                "image_url": "assets/grilon3/petg-clear-verde.jpg",
            },
        },
    )
    ...
    enrichments = build_grilon3_enrichments(
        [
            raw(
                ...
                "Filamentos3D",
                "Zona Sur",
                "MEGAFILL GRILON3 PETG 87_CLEAR VERDE 1.75 MM X 4 KG",
                4,
                brand_hint="Grilon3",
            )
        ],
    ...
    enrichment = next(iter(enrichments.values()))
    assert enrichment["manufacturer_product_url"] == "https://grilon3.com.ar/producto/filamento-3d-petg-clear-verde/"
    assert enrichment["image_url"] == "assets/grilon3/petg-clear-verde.jpg"


def test_build_grilon3_enrichments_prefers_large_roll_family_metadata_for_large_products(monkeypatch):
    monkeypatch.setattr(
        "centraldefilamentos.build_data.load_grilon3_metadata",
        lambda: {
            "petg-blanco-285-1000-grilon3": {
                "manufacturer_product_url": "https://grilon3.com.ar/producto/petg-blanco-285/",
                "image_url": "assets/grilon3/petg-285-blanco.jpg",
            },
            "petg-blanco-unknown-1000-grilon3": {
                "manufacturer_product_url": "https://grilon3.com.ar/producto/maxicarrete-petg-blanco/",
                "image_url": "assets/grilon3/petg-maxicarrete-blanco.jpg",
    ...
    enrichments = build_grilon3_enrichments(
        [
            raw(
                ...
                "Filamentos3D",
                "Zona Sur",
                "GRILON3 PETG Blanco 2.5kg 1.75mm",
                4,
                brand_hint="Grilon3",
            )
        ],
    ...
    enrichment = next(iter(enrichments.values()))
    assert enrichment["manufacturer_product_url"] == "https://grilon3.com.ar/producto/maxicarrete-petg-blanco/"
    assert enrichment["image_url"] == "assets/grilon3/petg-maxicarrete-blanco.jpg"


def test_build_grilon3_enrichments_keeps_official_image_when_product_url_has_full_color(monkeypatch):
    monkeypatch.setattr(
        "centraldefilamentos.build_data.load_grilon3_metadata",
        lambda: {
            "pla-gris-espacial-unknown-1000-grilon3": {
                "manufacturer_product_url": "https://grilon3.com.ar/producto/filamento-3d-pla-gris-espacial/",
                "image_url": "assets/grilon3/pla-gris.jpg",
                "sku": "SKU-GRIS-ESPACIAL",
            },
        },
    )
    ...
    enrichments = build_grilon3_enrichments(
        [
            raw(
                ...
                "Filamentos3D",
                "Zona Sur",
                "GRILON3 PLA Gris Espacial 1kg 1.75mm",
                4,
                brand_hint="Grilon3",
            )
        ],
    ...
    enrichment = next(iter(enrichments.values()))
    assert enrichment["image_url"] == "assets/grilon3/pla-gris.jpg"
    assert enrichment["sku"] == "SKU-GRIS-ESPACIAL"

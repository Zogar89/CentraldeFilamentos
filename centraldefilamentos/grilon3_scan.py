...
def _product_payload(
    ...
    return {
        ...
        "color": fields.color,
        "diameter_mm": fields.diameter_mm if fields.diameter_mm is not None else detail.diameter_mm if detail else None,
        "weight_g": fields.weight_g if fields.weight_g is not None else detail.weight_g if detail else None,
        "brand": fields.brand,
